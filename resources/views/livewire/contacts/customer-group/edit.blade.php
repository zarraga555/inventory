@section('title')
    {{ __('Edit customer groups') }}
@endsection
<div>
    <div class="mb-6 w-full">
        <div class="flex justify-between items-center">
            <div>
                <flux:heading class="mb-2" size="xl" level="1">{{ __('Edit customer groups') }}</flux::heading>
                    <flux:breadcrumbs>
            ...
            @can('customer-group.delete')
                <flux:modal.trigger name="confirmingCustomerGroupsDeletion">
    ...
    <div class="mt-8 self-stretch max-md:pt-6">
        ...
        @include('livewire.contacts.customer-group.modalDelete')
    </div>
